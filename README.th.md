...
> **คู่มือการติดตั้งฉบับเต็ม:** [docs/01-getting-started/GETTING-STARTED.md](docs/01-getting-started/GETTING-STARTED.md)

---

## 🎓 Workshop: เรียนรู้แบบจับมือทำ
...
**เรียนรู้เพิ่มเติม:** [docs/09-reference/OPENCODE-AGENTS.th.md](docs/09-reference/OPENCODE-AGENTS.th.md)
...
> **ดู workflow ละเอียด:** [Use Cases - หา Citation ที่ขาด](docs/08-examples/USE-CASES.th.md#2-workflow-การหา-citation-ที่ขาด)
```
...
| เอกสาร | คำอธิบาย |
|---------|-----------|
| [Getting Started](docs/01-getting-started/GETTING-STARTED.md) | การติดตั้งและการตั้งค่า |
| [Architecture](docs/02-concepts/ARCHITECTURE.md) | การออกแบบระบบและความสัมพันธ์ของ components |
| [Workflow](docs/02-concepts/WORKFLOW.md) | Pipeline workflows พร้อมแผนภาพ |

### เครื่องมือและ Skills

| เอกสาร | คำอธิบาย |
|---------|-----------|
| [Capabilities](docs/03-tools/CAPABILITIES.md) | คู่มือเครื่องมือ (11) และ skills (7) ฉบับเต็ม |
| [Skills Guide](docs/04-skills/SKILLS-GUIDE.md) | วิธีใช้แต่ละ skill |

### คุณภาพและการปฏิบัติตามมาตรฐาน

| เอกสาร | คำอธิบาย |
|---------|-----------|
| [ISO 29110 Report](docs/10-meta/ISO29110-REPORT.md) | การวิเคราะห์ความสอดคล้อง ISO |
| [Examples](docs/08-examples/EXAMPLES.md) | ตัวอย่างผลลัพธ์จริง |

### การพัฒนาและการมีส่วนร่วม

| เอกสาร | คำอธิบาย |
|---------|-----------|
| [Development Journey](docs/10-meta/DEVELOPMENT-JOURNEY.md) | เรื่องราวการพัฒนาโปรเจกต์ |
| [Roadmap](docs/10-meta/ROADMAP.md) | แผนการพัฒนาในอนาคต |
| [Contributing](docs/10-meta/CONTRIBUTING.md) | วิธีมีส่วนร่วม |

### ขั้นสูง

| เอกสาร | คำอธิบาย |
|---------|-----------|
| [Use Cases](docs/08-examples/USE-CASES.th.md) | ไอเดียการใช้งาน 10+ กรณี |
| [OpenCode Agents](docs/09-reference/OPENCODE-AGENTS.th.md) | ระบบ Agent และการเลือก Model |
| [Troubleshooting](docs/09-reference/TROUBLESHOOTING.th.md) | ปัญหาที่พบบ่อยและวิธีแก้ |
