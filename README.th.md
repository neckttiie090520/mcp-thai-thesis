...
> **ดู workflow ละเอียด:** [Use Cases - หา Citation ที่ขาด](docs/USE-CASES.th.md#2-workflow-การหา-citation-ที่ขาด)
```
...
| [Troubleshooting](docs/TROUBLESHOOTING.th.md) | ปัญหาที่พบบ่อยและวิธีแก้ |
